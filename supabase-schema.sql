...
CREATE TABLE IF NOT EXISTS products (
  ...
  specifications JSONB DEFAULT '{}', -- { ram: "8GB", storage: "128GB", battery: "5000mAh", display: "6.5 inch", camera: "108MP", os: "Android" }
...
-- Ensure single row (using a check constraint approach)
-- We'll manage this in application logic
...
-- Products (Smartphones - realistic Bangladesh market models)
...
-- ============================================
-- DISABLE RLS (Demo Only - As Requested)
-- ============================================
